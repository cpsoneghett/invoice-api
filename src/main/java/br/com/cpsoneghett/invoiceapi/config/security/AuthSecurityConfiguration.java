...
public class AuthSecurityConfiguration {
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder encoder) {
        ...
        RegisteredClient cpsonUserClient = RegisteredClient
                .withId("1")
                .clientId("cpson")
        ...
        RegisteredClient apiConsumerClient = RegisteredClient
                .withId("2")
                .clientId("apiConsumer_1")
        ...
        return new InMemoryRegisteredClientRepository(
                List.of(cpsonUserClient, apiConsumerClient)
        );
    }
    ...
    public JWKSet jwkSet(AuthProperties authProperties) throws Exception {
        ...
        final String jksPath = jksProperties.path();
        final InputStream inputStream = new ClassPathResource(jksPath).getInputStream();

        final KeyStore keyStore = KeyStore.getInstance("JKS");
        keyStore.load(inputStream, jksProperties.storepass().toCharArray());

        RSAKey rsaKey = RSAKey.load(keyStore, jksProperties.alias(), jksProperties.keypass().toCharArray());
